...
<section class="h-100 gradient-form custom-bg-color"> 
                    ...
                    <div class="row g-0">
                        <div class="col-lg-6">
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <div class="text-center">
                                    <img src="/Recipe_Cook/assets/logo.png" class="logo" alt="logo">
                        ...
                        <div class="col-lg-6 d-flex align-items-center justify-content-center gradient-custom-2">
                            <div class="text-white pt-5">    
                                <div class="text-center">
                                    <img src="/Recipe_Cook/assets/logo.png" class="logo-inverted" alt="logo">
                                    <h4 class="mt-3">Vous n'avez pas de compte ?</h4>
                                    <p class="mb-4 customtxtsize">Créez-vous en un</p>
                                </div>
                                ...
                                <form method="POST" action=""> 
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <div class="form-outline flex-fill mb-0">
                                            <label class="form-label" for="password_verif">Confirmez votre mot de passe*</label>
